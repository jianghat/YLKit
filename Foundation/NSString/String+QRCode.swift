...
extension String {
    ...
    func generateQRCode(size:CGFloat?,color:UIColor?,bgColor:UIColor?,logo:UIImage?,radius:CGFloat,borderLineWidth:CGFloat?,borderLineColor:UIColor?,boderWidth:CGFloat?,borderColor:UIColor?) -> UIImage {
        ...
        //线框
        let logoBorderLineImagae = QRCodeLogo.roundImage(size: logoWidth, radius: radius, borderWidth: borderLineWidth, borderColor: borderLineColor)
        //边框
        let logoBorderImagae = logoBorderLineImagae.roundImage(size: logoWidth, radius: radius, borderWidth: boderWidth, borderColor: borderColor)
